...
label1 = b.Label3DFlat(follows = box1, text = "Pabellon 1")

label2 = b.Label3DFlat(follows = box2, text = "Pabellon 2")

label3 = b.Label3DFlat(follows = box3, text = "Pabellon 3")

label4 = b.Label3DFlat(follows = box4, text = "Pabellon 4")
